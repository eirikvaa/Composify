...
final class CreateNewProjectTableViewDataSource: AdministrateProjectTableViewDataSource {
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case (2, _):
            ...
            configureCloseCell(closeCell, administrateProjectViewController)
...
private extension CreateNewProjectTableViewDataSource {
    func configureCloseCell(_ closeCell: ButtonTableViewCell, _ administrateProjectViewController: CreateNewProjectViewController) {
